...
//length*2-1
//line traverses odd indices
//obstacle lives in even indices
...
class Grid{
  constructor(level, stage){
    ...
    // this.board = new Array(this.length*2-1);
    // for (var i = 0; i < this.board.length; i++) {
    //   this.board[i] = new Array(this.length*2-1);
    // }

    // this.obs = this.initilizeObstacles(level.obs);
...
// initilizeObstacles(obstacles){
    // return obstacles.map((el) => {return new Obstacle(el)});
// }
